...
<html xmlns:ix="http://www.xbrl.org/2013/inlineXBRL" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:ind-as="http://example.test/ind-as">
  <body>
    <ix:header>
      <xbrli:context id="c1">
    ...
    assert by_metric["revenue"]["unit"] == "INR absolute"
