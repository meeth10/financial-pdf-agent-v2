...
<style>
body{margin:0;background:#f5f6f8;color:#111827;font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif}.app{max-width:1250px;margin:auto;padding:32px 22px 60px}.top{display:flex;justify-content:space-between;gap:20px;align-items:end}.eyebrow{font-size:12px;letter-spacing:.12em;text-transform:uppercase;color:#6b7280;font-weight:700}.title{font-size:34px;font-weight:800;margin:4px 0}.sub{color:#6b7280;max-width:760px}.panel{background:white;border:1px solid #e3e7ee;border-radius:16px;box-shadow:0 10px 30px rgba(15,23,42,.06);padding:22px;margin-top:18px}.grid{display:grid;grid-template-columns:1fr 180px 1fr;gap:12px}.field{display:flex;flex-direction:column;gap:6px}.field label{font-size:12px;color:#6b7280;font-weight:700}.field input,.question{border:1px solid #d9dee7;border-radius:10px;padding:11px 12px;font-size:14px}.button{border:0;border-radius:10px;padding:11px 16px;font-weight:750;background:#111827;color:#fff;cursor:pointer}.button:disabled{opacity:.5}.muted{color:#6b7280;font-size:13px}.status{margin-top:12px;color:#6b7280}.bar{height:4px;background:#e9edf2;border-radius:9px;margin-top:10px;overflow:hidden;display:none}.bar i{display:block;width:35%;height:100%;background:#111827;animation:slide 1s infinite}@keyframes slide{from{margin-left:-40%}to{margin-left:110%}}.summary{display:grid;grid-template-columns:repeat(4,1fr);gap:10px;margin-top:18px}.card{padding:15px;border:1px solid #e7ebf0;border-radius:12px}.label{font-size:11px;text-transform:uppercase;letter-spacing:.08em;color:#6b7280;font-weight:700}.value{font-size:25px;font-weight:800;margin-top:5px}.tabs{display:flex;gap:6px;margin-bottom:14px}.tab{flex:1;border:0;padding:10px;border-radius:9px;background:#eef1f5;color:#6b7280;font-weight:750;cursor:pointer}.tab.active{background:#fff;box-shadow:0 2px 8px rgba(15,23,42,.08);color:#111827}.statement{display:none}.statement.active{display:block}.candidate{border:1px solid #e3e7ee;border-radius:12px;margin:9px 0;overflow:hidden}.candidate summary{padding:13px 15px;cursor:pointer;display:flex;justify-content:space-between;gap:15px;list-style:none}.candidate summary::-webkit-details-marker{display:none}.body{padding:0 15px 15px;border-top:1px solid #e3e7ee}.chips{display:flex;gap:6px;flex-wrap:wrap;margin-top:11px}.chip{font-size:11px;padding:4px 7px;background:#f0f2f5;border-radius:999px;color:#5f6876}.chip.good{background:#e8f7ee}.chip.warn{background:#fff3df}.chip.bad{background:#fdecea}.pre{white-space:pre-wrap;color:#6b7280;font-size:12px;line-height:1.5;margin-top:10px}.qa{display:grid;grid-template-columns:1fr auto;gap:10px}.answer{white-space:pre-wrap;line-height:1.6;font-size:14px;margin-top:15px;border-top:1px solid #e7ebf0;padding-top:15px}.hidden{display:none}@media(max-width:800px){.grid,.qa{grid-template-columns:1fr}.summary{grid-template-columns:1fr 1fr}.top{flex-direction:column;align-items:flex-start}}
</style></head>
<body><div class="app">
